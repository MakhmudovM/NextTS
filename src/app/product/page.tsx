  ...
  return (
   <div>
    ...
    {data.products.map((product: Product) => (
      ...
      <img src={product.thumbnail} alt={product.title}  className=" w-full h-80 bg-slate-500 rounded-lg object-cover  "/>
